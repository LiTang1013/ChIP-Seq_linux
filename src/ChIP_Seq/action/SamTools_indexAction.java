 ...
 */
public class SamTools_indexAction extends ActionSupport {
    ...
    public String Index() throws Exception{
        ...
        xmlUtil.xmlAdd_Jobs(JobId,fileList, "Samtools_index", "ERROR","email",time);
    ...
    public void validate(){
        if(samtools_index_radio!=1&&samtools_index_radio!=2&&samtools_index_radio!=3){
            this.addFieldError("samtools_index_radio", "Please choose the format.");
        }
        if(input_samtools_index.equals("")){
            this.addFieldError("input_samtools_index", "Please input the index file.");
        }
        try{
            UploadUtil uploadUtil2=new UploadUtil();
            if(!uploadUtil2.Check(fileField_samtools_indexFileName,fileField_samtools_index)){
