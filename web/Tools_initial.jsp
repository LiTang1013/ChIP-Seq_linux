...
<<<<<<< HEAD
        ...
        function checkFileExt(filename,box) {
            var flag=null; //状态
            var arr =["fasta","fastq","fa","fq",".bed","BED",".bam",".sam","ELAND","ELANDMULTI"];
            //取出上传文件的扩展名
    ...
    <div id="side_center">
        <div id="left_side">
            ...
            <div id="side_1" style="display: block">
                <div class="side_son" id="side_son_1" style="background-color: #fa7923;color:#ffffff" onclick="JavaScript:side_right_show(1,22)"; style="cursor:hand;">BWA</div>
                <div class="side_son" id="side_son_2"  onclick="JavaScript:side_right_show(2,22)">Bowtie</div>
                <div class="side_son" id="side_son_3"  onclick="JavaScript:side_right_show(3,22)">Bowtie2</div>
                <div class="side_son" id="side_son_4"  onclick="JavaScript:side_right_show(4,22)">SOAP</div>
                <div class="side_son" id="side_son_5"  onclick="JavaScript:side_right_show(5,22)">BLAST</div>
                <div class="side_son" id="side_son_6"  onclick="JavaScript:side_right_show(6,22)">Subread</div>
                <div class="side_son" id="side_son_7"  onclick="JavaScript:side_right_show(7,22)">NGM</div>
            </div>
...
<<<<<<< HEAD
                        ...
                        <div class="file-box" id="file-box_BWA_paired" style="display:none;">
                            <input type="text" name="input_BWA_reads_pair1" class="input_text_pair" id="input_BWA_reads_pair1" value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bwa" class="fileField_pair1" id="fileField_bwa_file1" onchange="return (fileChange(this,'input_BWA_reads_pair1' )&& checkFileExt(this.value,'input_BWA_reads_pair1'))" />
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="advancedPair_o" name="advancedPair_o" class="input_setting_text" value="100000" />
                            ...
                            <input type="text" id="advancedPair_n" name="advancedPair_n" class="input_setting_text" value="3" />
                            ...
                            <input type="text" id="advancedPair_NN" name="advancedPair_N" class="input_setting_text" value="10" />
...
<<<<<<< HEAD
                        ...
                        <div class="file-box_pair" id="file-box_bowtie_reads_pair" style="display:none;">
                            <input type="text" id="input_reads_pair1_bowtie" name="input_reads_pair1_bowtie"  class="input_text_pair" id="input_reads_pair1_bowtie"  value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie" class="fileField_pair1" id="fileField_bowtie_read1" onchange="return (fileChange(this,'input_reads_pair1_bowtie' )&& checkFileExt(this.value,'input_reads_pair1_bowtie'))" />
                            <input type="text" id="input_reads_pair2_bowtie" name="input_reads_pair2_bowtie"  class="input_text_pair" id="input_reads_pair2_bowtie"  value="reads_2.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie" class="fileField_pair2" id="fileField_bowtie_read2" onchange="return (fileChange(this,'input_reads_pair2_bowtie' )&& checkFileExt(this.value,'input_reads_pair2_bowtie'))" />
=======
                        ...
                        <div class="file-box_pair" id="file-box_bowtie_reads_pair" style="display:none;">
                            ...
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie" class="fileField_pair1" id="fileField_bowtie_read1" onchange="document.getElementById('input_reads_pair1_bowtie').value=this.value;fileChange(this,'input_reads_pair1_bowtie');" />
                            <input type="text" name="input_reads_pair2_bowtie"  class="input_text_pair" id="input_reads_pair2_bowtie"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie" class="fileField_pair2" id="fileField_bowtie_read2" onchange="document.getElementById('input_reads_pair2_bowtie').value=this.value;fileChange(this,'input_reads_pair2_bowtie');" />
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
                        </div>
                    </div>
...
<<<<<<< HEAD
                            ...
                            <h6>-l;more than 5.</h6>
                            <input type="text" id="bowtie_mode_l" name="bowtie_mode_l" class="input_setting_text" value="5" /><br>
                            ...
                            <input type="text" id="bowtie_mode_e" name="bowtie_mode_e" class="input_setting_text" value="40"/><br>
...
<<<<<<< HEAD
                        ...
                        <div class="file-box" id="file-box_tools_reads_pair" style="display:none;">
                            <input type="text" id="input_reads_pair1" name="input_reads_pair1"  class="input_text_pair" id="input_reads_pair1"  value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie2" class="fileField_pair1" id="fileField_bowtie2_pair1" onchange="return (fileChange(this,'input_reads_pair1' )&& checkFileExt(this.value,'input_reads_pair1'))" />
                            <input type="text" id="input_reads_pair2" name="input_reads_pair2"  class="input_text_pair" id="input_reads_pair2"  value="reads_2.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_bowtie2" class="fileField_pair2" id="fileField_bowtie2_pair2" onchange="return (fileChange(this,'input_reads_pair2' )&& checkFileExt(this.value,'input_reads_pair2'))" />
=======
...
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
                ...
                <div class="link" qonclick="JavaScript:nece_opt_show_op();"style="cursor:hand;">
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="alignment_i" name="alignment_i"class="input_setting_text" value="S,1,1.15" />
                            ...
                            <input type="text" id="alignment_n" name="alignment_n"class="input_setting_text" value="L,0,0.15" />
                            Pad dynamic programming problems by that many columns on either side to allow gaps.
                            <h6>--dpad; default=15</h6>
                            <input type="text" id="alignment_dpad" name="alignment_dpad"class="input_setting_text" value="15" />
...
<<<<<<< HEAD
                        ...
                        <div class="file-box" id="file-box_SOAP_paired" style="display:none;">
                            <input type="text" id="input_SOAP_reads_pair1"  name="input_SOAP_reads_pair1" class="input_text_pair" id="input_SOAP_reads_pair1"  value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_soap" class="fileField_pair1" id="fileField_soap_pair1" onchange="return (fileChange(this,'input_SOAP_reads_pair1' )&& checkFileExt(this.value,'input_SOAP_reads_pair1'))" />
                            <input type="text" id="input_SOAP_reads_pair2"  name="input_SOAP_reads_pair2" class="input_text_pair" id="input_SOAP_reads_pair2"  value="reads_2.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_soap" class="fileField_pair2" id="fileField_soap_pair2" onchange="return (fileChange(this,'input_SOAP_reads_pair2' )&& checkFileExt(this.value,'input_SOAP_reads_pair2'))" />
=======
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="SOAP_l" name="SOAP_l" class="input_setting_text" value="256" /><br>
                            -n
                            ...
                            <input type="text" id="SOAP_r" name="SOAP_r" class="input_setting_text" value="1" /><br>
                            -m
                            ...
                            <input type="text" id="SOAP_s" name="SOAP_s" class="input_setting_text" value="255"/><br>
                            -g
                            ...
                            <input type="text" id="SOAP_e" name="SOAP_e" class="input_setting_text" value="5" /><br>
                            -p
...
=======
                            ...
                            -l
                            <h6>align the initial n bps as a seed [256] means whole length of read</h6>
                            <input type="text" name="SOAP_l" class="input_setting_text" value="256"/><br>
                            -n
                            <h6>filter low-quality reads containing >n Ns before alignment, [5]</h6>
                            <input type="text" name="SOAP_n" class="input_setting_text" value="5"/><br>
                            -r[0,1,2]
                            <h6>how to report repeat hits, 0=none; 1=random one; 2=all, [1]</h6>
                            <input type="text" name="SOAP_r" class="input_setting_text" value="1"/><br>
                            -m
                            <h6>minimal insert size allowed, [400]</h6>
                            ...
                            -p
                            <h6>number of processors to use, [1]</h6>
                            <input type="text" name="SOAP_p" class="input_setting_text" value="1"/><br>
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="blast_max_target_seqs" name="blast_max_target_seqs" class="input_setting_text" value="500" />
                            <div id="optional_center_setting_blastn" style="display:block">
                                word_size<br>
                                <h6>default:11;Length of initial exact match.</h6>
                                <input type="text" id="blast_word_size" name="blast_word_size" class="input_setting_text" value="11" />
                                gapopen	<br>
                                <h6>default:5;Cost to open a gap. See appendix “BLASTN reward/penalty values”.</h6>
                                <input type="text" id="blast_gapopen" name="blast_gapopen" class="input_setting_text" value="5"/>
                                reward	<br>
                                <h6>default:2;Reward for a nucleotide match.</h6>
                                <input type="text" id="blast_reward" name="blast_reward" class="input_setting_text" value="2" />
                                penalty	<br>
                                <h6>default:-3;Penalty for a nucleotide mismatch.</h6>
                                <input type="text" id="blast_penalty" name="blast_penalty" class="input_setting_text" value="-3" />
                                strand<br>
                                <h6>default:both;Query strand(s) to search against database/subject. Choice of both, minus, or plus.</h6>
                                <input type="text" id="blast_strand" name="blast_strand" class="input_setting_text" value="both" />
                                dust<br>
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="blast_gapextend"  name="blast_gapextend" class="input_setting_text" value="1" />
                                threshold	<br>
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="blast_seg"  name="blast_seg" class="input_setting_text" value="no" />
                                soft_masking	<br>
                                <h6>default:false;Apply filtering locations as soft masks (i.e., only for finding initial matches).</h6>
                                <input type="text" id="blast_soft_masking" name="blast_soft_masking" class="input_setting_text" value="false" />
                                window_size	<br>
...
<<<<<<< HEAD
                        ...
                        <div class="file-box" id="file-box_Subread_paired" style="display:none;">
                            <input type="text" id="input_Subread_reads_pair1" name="input_Subread_reads_pair1" class="input_text_pair" id="input_Subread_reads_pair1"  value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_subread" class="fileField_pair1" id="fileField_subread_pair1" onchange="return (fileChange(this,'input_Subread_reads_pair1' )&& checkFileExt(this.value,'input_Subread_reads_pair1'))" />
...
=======
                            <input type="text" name="Subread_M" class="input_setting_text" value="8000"/>
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="Subread_d" name="Subread_d" class="input_setting_text" value="50" /><br>
                            -D < int >( maxFragLength )<br>
                            <h6>Specify the maximum fragment/template length, 600 by default.</h6>
                            <input type="text" id="Subread_DD"  name="Subread_D" class="input_setting_text" value="600" /><br>
                            -I < int >( indels )<br>
                            <h6>Specify the number of INDEL bases allowed in the mapping. 5 by
                                default. Indels of up to 200bp long can be detected.</h6>
                            <input type="text" id="Subread_I" name="Subread_I" class="input_setting_text" value="5" /><br>
                            -m < int >( TH1 )<br>
...
<<<<<<< HEAD
                            ...
                            <h6>Specify the number of subreads extracted from each read, 10 by
                                default.</h6>
                            <input type="text" id="Subread_n" name="Subread_n" class="input_setting_text" value="10" /><br>
                            -p < int >( TH2 )<br>
                            <h6>Specify the minimum number of consensus subreads both reads
                                from the same pair must have.1 by default.</h6>
                            <input type="text" id="Subread_p" name="Subread_p" class="input_setting_text" value="1" /><br>
...
<<<<<<< HEAD
                            ...
                            <input type="text" id="Subread_T" name="Subread_T" class="input_setting_text" value="1" /><br>
                            −−trim5 < int >( nTrim5 )<br>
                            <h6>Trim off < int > number of bases from 5’ end of each read. 0 by
                                default.</h6>
                            <input type="text" id="Subread_trim5" name="Subread_trim5" class="input_setting_text" value="0"/><br>
                            −−trim3 < int >( nTrim3 )<br>
...
<<<<<<< HEAD
                            ...
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_ngm" class="fileField" id="fileField_ngm_re" onchange="return (fileChange(this,'input_NGM_reference' )&& checkFileExt(this.value,'input_NGM_reference'))" />
=======
...
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
                        ...
                        <div class="built_in" id="built_in_NGM" style="display: none;">
                            <select name="built_in_NGM" class="gomo_select"/>
                            <option value="1" selected="selected">Human(b37) hg19</option>
                            <option value="2">Human(b37) hg38</option>
                            </select><br>
                        </div>
...
<<<<<<< HEAD
                        ...
                        <div class="file-box" id="file-box_NGM_paired" style="display:none;">
                            <input type="text" id="input_NGM_reads_pair1" name="input_NGM_reads_pair1" class="input_text_pair" id="input_NGM_reads_pair1"  value="reads_1.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_ngm" class="fileField_pair1" id="fileField_ngm_pair1" onchange="return (fileChange(this,'input_NGM_reads_pair1' )&& checkFileExt(this.value,'input_NGM_reads_pair1'))" />
                            <input type="text" id="input_NGM_reads_pair2" name="input_NGM_reads_pair2" class="input_text_pair" id="input_NGM_reads_pair2"  value="reads_2.fastq"/>
                            <input type='button' class='btn' value='Choose File' />
                            <input type="file" name="fileField_ngm" class="fileField_pair2" id="fileField_ngm_pair2" onchange="return (fileChange(this,'input_NGM_reads_pair2' )&& checkFileExt(this.value,'input_NGM_reads_pair2'))" />
=======
...
<<<<<<< HEAD
                            ...
                            <h6>All reads mapped with lower than n mapping quality will be reported as unmapped.
                                (default: 0)</h6>
                            <input type="text" id="NGM_Q" name="NGM_Q" class="input_setting_text" value="0" /><br>
                            --bs-cutoff <br>
                            <h6>Max. number of Ts in a k-mer. All k-mers were
                                the number of Ts is higher than b are ignored (default: 8)</h6>
                            <input type="text" id="NGM_bc" name="NGM_bc" class="input_setting_text" value="8" /><br>
                            -k/--kmer [10-14] <br>
                            <h6>Kmer length in bases. (default: 13)</h6>
                            <input type="text"  id="NGM_k" name="NGM_k" class="input_setting_text" value="13" /><br>
                            --kmer-skip <br>
                            <h6>Number of k-mers to skip when building the
                                lookup table from the reference(default: 2)</h6>
                            <input type="text" id="NGM_ks"  name="NGM_ks" class="input_setting_text" value="2" /><br>
                            --kmer-min <br>
...
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
                    ...
                    <div id="necessary_center_multi" class="necessary_center" style="display:block">
                        <div class="blacktop_1">Choose the mode to compute the read coverage</div>
                        <div class="blackdown_1">
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="multi_bs" name="multi_bs"  class="input_setting_text" /><br>
                                ...
                                <input type="text" id="multi_n" name="multi_n" class="input_setting_text" /><br>
                                --region, -r<br>
                                ...
                                <input type="text" id="multi_r" name="multi_r" class="input_setting_text" /><br>
                                ...
                                <input type="text" id="multi_bl" name="multi_bl" class="input_setting_text" /><br>
                                ...
                                <input type="text" id="multi_p" name="multi_p" class="input_setting_text" /><br>
                                --outRawCounts<br>
                                <h6>Save the counts per region to a tab-delimited file.</h6>
                                <input type="text" id="multi_out" name="multi_out" class="input_setting_text" /><br>
                                --extendReads, -e<br>
...
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
                              <br>  --ignoreDuplicates<br>
                               ...
                               <br> --maxFragmentLength<br>
                                <h6>The maximum fragment length needed for read/pair inclusion. A value of 0 disables filtering and is needed for including single-end and orphan reads.</h6>
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="macs_bw" name="macs_bw" value="300" class="input_setting_text" />
                                Pvalue cutoff for peak detection<br>
                                <h6>Pvalue cutoff for peak detection. DEFAULT: 1e-5</h6>
                                <input type="text" id="macs_p" name="macs_p" value="1e-5" class="input_setting_text" />
...
=======
                <form action="Tools_MACS2_PeakCalling" enctype="multipart/form-data" method="post" onsubmit="document.getElementById('btn_MACS2').style.backgroundColor='#666666';document.getElementById('wait_MACS2').style.display='block';">
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="peakranger_annofile" name="peakranger_annofile" value="" class="input_setting_text" />
                               <br> p value cut off<br>
                                <h6>`-p,--pval` </h6>
                                <input type="text" id="peakranger_pvalue" name="peakranger_pvalue" value="" class="input_setting_text" />
                                FDR cut off<br>
                                <h6>`-q,--FDR` </h6>
                                <input type="text" id="peakranger_fdr" name="peakranger_fdr" value="" class="input_setting_text" />
                                read extension length<br>
                                <h6>`-l,--ext_length` </h6>
                                <input type="text" id="peakranger_relength" name="peakranger_relength" value="" class="input_setting_text" />
                                sensitivity of the summit detector<br>
                                <h6>`-r,--delta`</h6>
                                <input type="text" id="peakranger_delta" name="peakranger_delta" value="" class="input_setting_text" />
                                smoothing bandwidth.<br>
                                <h6>`-b,--bandwidth` </h6>
                                <input type="text" id="peakranger_bandwidth" name="peakranger_bandwidth" value="" class="input_setting_text"/>
                                pad read coverage to avoid false positive summits<br>
                                <h6>`--pad` </h6>
                                <input type="text" id="peakranger_pad" name="peakranger_pad" value="" class="input_setting_text"/>
...
<<<<<<< HEAD
                                ...
                                the gene annotation file<br>
                                <h6>`--gene_annot_file`</h6>
                                <input type="text" id="peakranger_annofile1" name="peakranger_annofile1" value="" class="input_setting_text" />
                                FDR cut off<br>
                                <h6>`-q,--FDR`</h6>
                                <input type="text" id="peakranger_fdr1" name="peakranger_fdr1" value="" class="input_setting_text" />
                                sliding window size<br>
                                <h6>`--win_size`</h6>
                                <input type="text" id="peakranger_winsize1" name="peakranger_winsize1" value="" class="input_setting_text" />
                                window moving step<br>
                                <h6>`--win_step`</h6>
                                <input type="text" id="peakranger_winstep1" name="peakranger_winstep1" value="" class="input_setting_text" />
                                minimum window reads count<br>
                                <h6>`--min_count`</h6>
                                <input type="text" id="peakranger_imcount1" name="peakranger_imcount1" value="" class="input_setting_text" />
                                minimum window reads fold change<br>
                                <h6>`--min_score`</h6>
                                <input type="text" id="peakranger_minscore" name="peakranger_minscore" value="" class="input_setting_text" />
                                read extension length<br>
                                <h6>`-l,--ext_length` </h6>
                                <input type="text" id="peakranger_relength1" name="peakranger_relength1" value="" class="input_setting_text" />
                                p value cut off<br>
                                <h6>`-p,--pval` </h6>
...
<<<<<<< HEAD
                                ...
                                the gene annotation file<br>
                                <h6>`--gene_annot_file`</h6>
                                <input type="text"  id="peakranger_annofile2" name="peakranger_annofile2" value="" class="input_setting_text" />
                                sliding window size<br>
                                <h6>`--win_size`</h6>
                                <input type="text" id="peakranger_winsize2" name="peakranger_winsize2" value="" class="input_setting_text"/>
                                read extension length<br>
                                <h6>`-l,--ext_length` </h6>
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="pepr_p" value="1e-5" class="input_setting_text" name="pepr_p" ><br>
                                --keep-max-dup<br>
...
=======
                                ...
                                window size<br>
                                <h6>Window size is a resolution parameter that is decided by user.We recommend 200bp as the default value because it isapproximately the size of a single nucleosome. </h6>
                                <input type="text" value="200" class="input_setting_text" name="BCP_W"><br>
                                p-value<br>
                                <h6>P-values are used when calling signicant segments compared to control data (default is 1e-3). </h6>
...
=======
                                <input type="text" value="10" class="input_setting_text" name="BCP_e"><br>
                                p-value<br>
                                <h6>p-value is also used to choose really significant peaks compared to the control data.The default p-value in the TFBS case is 1e-8. </h6>
...
=======
                                <input type="text" value="2" class="input_setting_text" name="SISSR_E"><br>
                                Upper-bound on the DNA fragment length. It is the approximate length/size of the longest
                                DNA fragment that was sequenced.<br>
                                <h6>Default: 500</h6>
...
<<<<<<< HEAD
                                ...
                                <input type="text" id="AREM_bw" value="300" class="input_setting_text" name="AREM_bw" ><br>
...
<<<<<<< HEAD
                                ...
                                <h6>For diagnostics, min fold enrichment to consider.
                                    DEFAULT: 0</h6>
                                <input type="text" id="AREM_femin" value="0" class="input_setting_text" name="AREM_femin" ><br>
                                --EM-converge-diff=MIN_CHANGE<br>
                                <h6>The minimum entropy change between iterations before
                                    halting E-M steps. DEFAULT : 1e-05</h6>
                                <input type="text" id="AREM_EM_cd" value="1e-05" class="input_setting_text" name="AREM_EM_cd" ><br>
                                ...
                                <input type="text" id="AREM_EM_min" value="1.5" class="input_setting_text" name="AREM_EM_min" ><br>
...
=======
                                ...
                                <h6>Prior probability that a SNP occurs at any base in the
                                    genome. DEFAULT : 0.001</h6>
                                <input type="text" value="0.001" class="input_setting_text" name="AREM_ps"><br>
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
...
>>>>>>> e936dd87b716fe25aca999e6e8b1f4143e34194c
            ...
            <div id="side_right_22" class="side_right" style="display:none">
                <div class="link" style="cursor:hand;" onclick="JavaScript:samtools_option(1);">
                    ...
                    Format convert<h8>(convert SAM to BAM/convert BAM to SAM)</h8>
                </div>
...
<<<<<<< HEAD
                        ...
                        <input type="submit" value="Execute" class="Execute_btn_samtools" id="btn_sam1"/><s:fielderror fieldName="check1" cssStyle="color:red;float:left;margin-top:0px;margin-right:10px;"  />
=======
                                <input type="text" name="samtobam_origin" class="input_text" id="samtobam_origin"/>
                                <input type='button' class='btn' value='Choose File' />
...
<<<<<<< HEAD
                    ...
                    <input type="submit" value="Execute" class="Execute_btn_samtools" id="btn_sam2"/><s:fielderror fieldName="check1" cssStyle="color:red;float:left;margin-top:0px;margin-right:10px;"  />
=======
                            <input type="text" name="input_samtools_sort" id="input_samtools_sort" class="input_text"/>
                            <input type='button' class='btn' value='Choose File' />
                ...
                <div id="samtools_center_3" class="necessary_center" style="display:block">
                    ...
                    <div class="blackdown_1">
                        <div class="file-box" style="display:block">
                            ...
                            <input type='button' class='btn' value='Choose File' />
<<<<<<< HEAD
                            <input type="file" name="fileField_samtools_index" class="fileField" id="fileField_samtools_index" onchange="return (fileChange(this,'input_samtools_index' )&& checkFileExt(this.value,'input_samtools_index'))" />
                        </div>
                    </div>

                    <input type="submit" value="Execute" class="Execute_btn_samtools" id="btn_sam3"/><s:fielderror fieldName="check1" cssStyle="color:red;float:left;margin-top:0px;margin-right:10px;"  />
=======
